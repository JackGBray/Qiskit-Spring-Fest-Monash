...
**10:10–10:20**  
- **Introduction to Quantum Australia** — *Olivia Dennis*
...
**1:00–1:45**  
- **Guest Seminar** — *Dr Anna Phan, Asia Pacific Lead for IBM Quantum Innovation Centres*

**1:50–2:30**  
- **Guest Lecture on QKD & PQC protocols** — *Nikai Jagganath, Monash University*
...
- **Quantum Hello World!** - [Notebook link](https://github.com/JackGBray/Qiskit-Spring-Fest-Monash/blob/main/Exercise_notebooks/Basics/hello-world.ipynb)
- **Qiskit Fundamentals Lab** — [Notebook link](https://github.com/JackGBray/Qiskit-Spring-Fest-Monash/blob/main/Exercise_notebooks/Basics/qiskit_fundamentals_lab-2.ipynb)  
- **Qiskit: Intro to Quantum Computing** — [Notebook link](https://github.com/JackGBray/Qiskit-Spring-Fest-Monash/blob/main/Exercise_notebooks/Extension/divincenzo_criteria_lab-2.ipynb)  
- **Example: Implementing a Quantum Algorithm** — [Notebook link](https://github.com/JackGBray/Qiskit-Spring-Fest-Monash/blob/main/Exercise_notebooks/Extension/chsh-inequality.ipynb)
...
qBraid gives everyone **~10 minutes of free IBM Quantum compute time**, so getting set up before the event lets you jump straight into coding on real hardware.


## Learn More (optional)

- **Qiskit YouTube channel** — tutorials, demos, talks: [link](https://www.youtube.com/qiskit)  
- **Quantum Computing in Practice(video)** — [link](https://www.youtube.com/playlist?list=PLOFEBzvs-VvoZxe2ClFy27yOt6VzsTEJK)  
- **Intro to Quantum Information (video/playlist)** — [link](https://www.youtube.com/watch?v=42OiBzfdE2o&list=PLOFEBzvs-VvqKKMXX4vbi4EB1uaErFMSO&index=1)
